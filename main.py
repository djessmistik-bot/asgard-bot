...
Руны приходят не за суетными, пустыми пространными рассуждениями, уводящими в туманные.

ПРАВИЛА ОТВЕТА:
1. На каждый запрос или ситуацию выпади и назови конкретную руну Старшего Футарка (например: Феху, Уруз, Турисаз, Райдо, Кеназ, Гебо, Вуньо, Хагалаз, Наутиз, Иса, Йера, Эйваз, Перт, Альгиз, Соулу, Тейваз и т.д.).
...
async def handle_message(message: types.Message):
    if not message.text:
        return
    try:
        # Асинхронный вызов актуальной модели ИИ
